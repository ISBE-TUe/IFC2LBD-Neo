...
def render_markdown(summary: dict[str, object]) -> str:
    ...
    lines.extend(
        [
            ...
            "## Chunk Metadata",
            "",
            "### model A Representative Chunked N-Quads Run",
            "",
    ...
    lines.extend(
        [
            "",
            f"- model A chunk policy: `cores`, `chunk_size_lines = {summary['digitalhub_chunk_metadata']['digitalhub-lbd.manifest.json']['chunk_size_lines']}`, `chunk_size_bytes = {summary['digitalhub_chunk_metadata']['digitalhub-lbd.manifest.json']['chunk_size_bytes']}`.",
            "",
    ...
    lines.extend(
        [
            ...
            "## Method Notes",
            "",
            "- model A remains the repeated benchmark section with `n = 20` and `μ ± σ` reporting.",
