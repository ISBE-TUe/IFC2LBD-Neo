...
Port in this order (most common first in DigitalHub.ifc):
...
Integration test: compare geometry counts on DigitalHub.ifc using `frag-diff`.
Full parity check: `python3 scripts/validate_fragments_parity.py web/wasm-prototype/public/DigitalHub.ifc`
