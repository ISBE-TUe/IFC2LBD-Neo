...
The five DigitalHub configurations should appear in the paper with these labels:
- `Java LBD + IfcOWL (TTL)`
- `Rust LBD + IfcOWL (TTL)`
...
#### 1.3 DigitalHub Comparison Checks
...
Recommended paper assets from the repeated DigitalHub run:
...
### 2. DigitalHub Rust Mode Comparison
...
- `4.4 Performance Comparison`
  - DigitalHub Java vs Rust baseline
- `4.5 Mode Comparison`
  - DigitalHub Rust mode runs
...
- Treat DigitalHub IfcOWL as the closest completeness comparison.
- State explicitly that the DigitalHub LBD surface is not a strict 1:1 oracle.
